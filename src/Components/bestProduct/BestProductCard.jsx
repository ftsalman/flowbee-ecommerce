...
import { assets } from "../../../public/images/grocery/assets";

export const BestProductCard = ({ product }) => {
  const [count, setCount] = useState(0);

  return (
    <div className="border border-gray-300 rounded-md px-3 md:px-4 py-2 bg-white min-w-56 max-w-56 w-full">
      {/* Product Image */}
              ...
              >
                ...
                >
                  <path
                    ...
                    stroke="#615fff"
                    strokeLinecap="round" // ✅ camelCase fix
                    strokeLinejoin="round" // ✅ camelCase fix
                  />
                </svg>
                Add
              </button>
